...
public class RegistrationPharmaciest {
    AppiumDriver driver;
    ...
    @Test
    public void registrationNewPharmaciest() {
        ...
        //выбираем тип регистрируемого юзера "фармацевт"
        WebElement selectPharm = driver.findElement(By.id("com.pharmbonus.by.test:id/btnAsPharmacist"));
        selectPharm.click();
        ...
        //нажимаем по полю workOrganisation на втором шаге регистрации
        ...
        //выбираем workPharmacy пользователя
        WebElement workPharmacy = new WebDriverWait(driver, Duration.ofSeconds(10))
                .until(ExpectedConditions.elementToBeClickable(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.ScrollView/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.LinearLayout[3]/android.widget.FrameLayout/android.widget.EditText")));
        workPharmacy.click();

        //нажимаем по полю selectPharmacy на втором шаге регистрации
        WebElement selectPharmacy = new WebDriverWait(driver, Duration.ofSeconds(10))
                .until(ExpectedConditions.elementToBeClickable(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.RelativeLayout/androidx.recyclerview.widget.RecyclerView/android.widget.LinearLayout[8]")));
        selectPharmacy.click();

        //выбираем userJobPosition пользователя фармацевта
        WebElement userJobPosition = new WebDriverWait(driver, Duration.ofSeconds(10))
                .until(ExpectedConditions.elementToBeClickable(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.ScrollView/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.LinearLayout[4]/android.widget.FrameLayout/android.widget.EditText")));
        userJobPosition.click();

        //выбираем selectPosition пользователя на втором шаге регистрации
        WebElement selectPosition = new WebDriverWait(driver, Duration.ofSeconds(10))
                .until(ExpectedConditions.elementToBeClickable(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.RelativeLayout/androidx.recyclerview.widget.RecyclerView/android.widget.LinearLayout[13]")));
        ...
        //нажимаем по кнопке laterVerification в открывшемся алерте на главном экране, когда пользователь авторизован
        WebElement laterVerification = new WebDriverWait(driver, Duration.ofSeconds(10))
                .until(ExpectedConditions.elementToBeClickable(By.id("android:id/button3")));
                laterVerification.click();
